      ...
      >
          ...
          >
            ...
            <el-dialog
              ...
              <el-col>
                <el-row>
                  <el-button v-for="(pitem,k) in treenum"
                          :key="k"
                          :label="pitem"
                          :value="pitem"
                          type="primary" round @click="execute(item.name,k)">{{k}}</el-button>
                </el-row>
              </el-col>
              <div :id="item.name" style="width: 90%; height: 2100px;float: left;"></div>
...
<script>
import { createResource, getResource, listResources, updateResource, deleteResource } from '@/api/k8sResource'
...
export default {
  ...
  data() {
    return {
      ...
      vmtype : [],
      colorlist: [],
      cpng: require('/home/huyi/code/code/pic/c.png'),
      rpng: require('/home/huyi/code/code/pic/r.png'),
      mpng: require('/home/huyi/code/code/pic/m.png'),
      form: {
        workload: '',
        framework: '',
        datasize: '',
  ...
  created(){
    const tobj = require('/home/huyi/code/code/vmtype.json')
    ...
    this.cardsData = tobj
    let dobj = require('/home/huyi/code/code/front.json')
